...
int main()
{
    ...
    cout<<endl <<"Vector o okreslonym rozmiarze:"<<endl;
    vector<float>vec2(5,8.2);
    show(vec2);
    vec2.push_back(3.1);
    show(vec2);

    cout<<endl<<endl<<"Biblioteka algorithm:"<<endl;
    ...
    cout<<endl<<endl<<"for_each oraz count_if"<<endl;
    ...
    cout<<endl<<endl<<"Wywolanie funkcji count_if w dwoch wersjach"<<endl;
    for_each(num.begin(),num.end(),print);
    cout<<endl;
